...
public class ParticipantAdapter extends RecyclerView.Adapter<ParticipantAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(com.tfg.marllor.orientatree.R.layout.row_participant, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull @NotNull View itemView) {
            ...
            participant_circleImageView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participant_row_circleImageView);
            name_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantName_textView);
            participantState_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantState_textView);
            start_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantStart_row_textView);
            finish_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantFinish_row_textView);
            row_participant_layout = itemView.findViewById(com.tfg.marllor.orientatree.R.id.row_participant_layout);
            participantPosition_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantPosition_textView);
            participantTotalTime_textView = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantTotalTime_textView);
            participantClassification_layout = itemView.findViewById(com.tfg.marllor.orientatree.R.id.participantClassification_layout);
        }
    }
}
