...
public class ReciclerListAdapter extends RecyclerView.Adapter<ReciclerListAdapter.MyViewHolder> {
    private ArrayList<Participation> emplist;
    private Context context;
    private Template template;
    private Activity activity;
    public ReciclerListAdapter(ArrayList<Participation> emplist, Template template, Activity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Log.v("Lista",String.valueOf(position+1));
        ...
        Log.v("Lista",currentParticipation.getState().toString());
    }
